...
export default function EnhancedFIRECalculator() {
  ...
  // Persist all calculator inputs to localStorage (debounced) so they survive login
  ...
  useEffect(() => {
    ...
    lsTimer.current = setTimeout(() => {
      saveLocalInputs({
        ...
        fireAge: 30, k401, rothIRA, taxable,
        totalDebt, mortgageBalance, mortgageMonthly,
        growthRate, withdrawalRate,
      });
    }, 600);
  }, [annualIncome, monthlyExpenses, k401, rothIRA, taxable, totalDebt, mortgageBalance, mortgageMonthly, growthRate, withdrawalRate]);
