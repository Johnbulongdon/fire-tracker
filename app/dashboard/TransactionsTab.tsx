                  ...
                  return (
                    <div key={txn.id} className="uf-card" style={{ padding: "14px 18px", display: "flex", alignItems: "center", gap: 12 }}>
                      ...
                      <div style={{ textAlign: "right", flexShrink: 0 }}>
                        ...
                        <button onClick={() => onDelete(txn.id)} style={{ background: "none", border: "none", color: "#5e5e7a", fontSize: 11, cursor: "pointer", marginTop: 4 }}>
                          delete
                        </button>
                      </div>
                    </div>
    ...
    <div className="uf-card" style={{ marginBottom: 24 }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 20 }}>
        ...
        <div style={{ display: "flex", gap: 4 }}>
          <button
            onClick={onPrevMonth}
            style={{ background: "#1c1c2e", border: "none", color: "#e8e8f2", borderRadius: 6, padding: "4px 12px", cursor: "pointer", fontSize: 16, lineHeight: 1 }}
          >
            ←
          </button>
          <button
            ...
            style={{ background: "#1c1c2e", border: "none", color: isCurrentMonth ? "#3a3a5a" : "#e8e8f2", borderRadius: 6, padding: "4px 12px", cursor: isCurrentMonth ? "default" : "pointer", fontSize: 16, lineHeight: 1 }}
          >
            →
          </button>
        </div>
...
export default function TransactionsTab() {
  ...
  if (loading) {
    return <div style={{ textAlign: "center", padding: "60px 0", color: "#5e5e7a" }}>Loading transactions...</div>;
  }
